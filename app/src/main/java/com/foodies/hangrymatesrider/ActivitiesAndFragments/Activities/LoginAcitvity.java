    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        log_in_now.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ed_email.getText().toString().trim().equals("")) {
                    ...
                    Toast.makeText(LoginAcitvity.this, "Please Accept Terms of Use & Privacy Policy", Toast.LENGTH_SHORT).show();
                }else {
        ...
        txt_terms.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(LoginAcitvity.this,TermsConditionActivity.class);
                ...
                try {
                    ...
                    if(code_id == 200) {
                        ...
                        if(resultObj2.optString("role").equalsIgnoreCase("rider")){
                            ...
                            Intent intent = new Intent(LoginAcitvity.this,RiderMainActivity.class);
