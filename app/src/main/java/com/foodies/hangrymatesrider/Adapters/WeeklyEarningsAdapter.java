...
import com.foodies.hangrymatesrider.Models.OrderModelClass;
...
public class WeeklyEarningsAdapter extends RecyclerView.Adapter<WeeklyEarningsAdapter.ViewHolder>  {

    ArrayList<OrderModelClass> getDataAdapter;
    Context context;
    WeeklyEarningsAdapter.OnItemClickListner onItemClickListner;

    public WeeklyEarningsAdapter(ArrayList<OrderModelClass> getDataAdapter, Context context){
        super();
    ...
    @Override
    public WeeklyEarningsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_items_orders, parent, false);

        WeeklyEarningsAdapter.ViewHolder viewHolder = new WeeklyEarningsAdapter.ViewHolder(v);
